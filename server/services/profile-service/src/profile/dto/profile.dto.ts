...
export class ProfileDataDto {
  @ApiProperty({ type: ProfileBasicsDto })
  @IsDefined()
  @ValidateNested()
  @Type(() => ProfileBasicsDto)
  basics!: ProfileBasicsDto;
  @ApiProperty({ type: ProfilePreferencesDto })
  @IsDefined()
  @ValidateNested()
  ...
  @ApiProperty({ type: [ProfileLanguageDto] })
  @IsDefined()
  @IsArray()
  @ArrayMaxSize(50)
  @ValidateNested({ each: true })
...
export class UpdateProfileDto {
  @ApiPropertyOptional({ type: ProfileBasicsDto })
  @IsOptional()
  @ValidateNested()
  @Type(() => ProfileBasicsDto)
  basics?: ProfileBasicsDto;
  ...
  @Type(() => ProfileSkillDto)
  skills?: ProfileSkillDto[];
  @ApiPropertyOptional({ type: [ProfileExperienceDto] })
  @IsOptional()
  @IsArray()
  @ArrayMaxSize(100)
  @ValidateNested({ each: true })
  @Type(() => ProfileExperienceDto)
  experience?: ProfileExperienceDto[];
  @ApiPropertyOptional({ type: [ProfileEducationDto] })
  @IsOptional()
  @IsArray()
  @ArrayMaxSize(50)
  @ValidateNested({ each: true })
  @Type(() => ProfileEducationDto)
  education?: ProfileEducationDto[];
  @ApiPropertyOptional({ type: [ProfileProjectDto] })
  @IsOptional()
  @IsArray()
  @ArrayMaxSize(100)
  @ValidateNested({ each: true })
  @Type(() => ProfileProjectDto)
  projects?: ProfileProjectDto[];
  @ApiPropertyOptional({ type: [ProfileLanguageDto] })
  @IsOptional()
  @IsArray()
  @ArrayMaxSize(50)
  @ValidateNested({ each: true })
...
export class ApplyCvImportDto {
  @ApiPropertyOptional({
    type: ProfileDataDto,
    description:
      'Reviewed data. When omitted, the extracted draft is merged into the profile.'
  })
  @IsOptional()
  @ValidateNested()
  @Type(() => ProfileDataDto)
